      ...
      <nav class="navbar" data-navbar>
        ...
        <ul class="navbar-list">
          ...
          <li class="navbar-item">
            <a href="index1.php" class="navbar-link">Home</a>
          </li>
          ...
          <li class="navbar-item">
            <a href="contact_us.php" class="navbar-link">Contact Us</a>
          </li>

          <li class="navbar-item">
            <a href="private-page.php" class="navbar-link">Profile</a>
          </li>
        ...
        <ul class="nav-action-list">
          ...
          <?php
// Check if the user is logged in (you may need to modify this based on your authentication logic)
$isLoggedIn = false;

// Assuming you have a session variable indicating the user's login status
...
<ul class="nav-action-list">
        ...
        <li>
            <a href="private-page.php" class="nav-action-btn">
                <ion-icon class="ion-icon" name="person-outline" aria-hidden="true"></ion-icon>
                <span>Profile</span>
            </a>
        </li>
  ...
  <footer class="footer">
          ...
          <ul class="footer-list">
            ...
            <li>
              <a href="#" class="footer-link">
                ...
                <span class="footer-link-text">01303664156</span>
              </a>
            </li>

            <li>
              <a href="koushikdewri33@gmail.con" class="footer-link">
                <ion-icon name="mail"></ion-icon>

                <span class="footer-link-text">koushikdewri33@gmail.con</span>
              </a>
            </li>
    ...
    <div class="footer-bottom">
      <div class="container">
        ...
        <p class="copyright">
          &copy; 2023 <a href="#" class="copyright-link">Koushik Dewri</a>. All Rights Reserved
        </p>
